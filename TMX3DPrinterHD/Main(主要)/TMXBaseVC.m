...
-(void)configureLeftBarButtonWithTitle:(NSString *)title icon:(NSString *)icon action:(leftBarButtonAction)action{
    if (title==nil) {
        ...
        self.leftBarButtonAction=action;
        self.navigationItem.leftBarButtonItem=[UIBarButtonItem normalTitle:title selectTitle:title normalColor: [UIColor blackColor] selectColor: [UIColor blackColor] normalImage:icon selectImage:icon target:self action:@selector(clickLeftBtn) size:CGSizeMake(60, 35) titleFont:[UIFont systemFontOfSize:14]];
    }
