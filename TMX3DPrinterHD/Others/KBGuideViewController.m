...
//        _startBtn.frame=CGRectMake(SCREENWIDTH/2-40*AppScale, SCREENHEIGHT-80, 80*AppScale, 35*AppScale);
        ...
        [_startBtn setTitle:@"立即体验" forState:0];
...
//        _skipBtn.frame=CGRectMake(SCREENWIDTH-100*AppScale, 20*AppScale, 80*AppScale, 35*AppScale);
//        _skipBtn.backgroundColor=systemColor;
        _skipBtn.layer.cornerRadius=5.0;
        _skipBtn.layer.masksToBounds=YES;
        _skipBtn.layer.borderWidth=1.0;
        _skipBtn.layer.borderColor=systemColor.CGColor;
        [_skipBtn setTitle:@"跳过" forState:0];
        [_skipBtn setTitleColor:[UIColor blackColor] forState:0];
//        _skipBtn.titleLabel.font=[UIFont systemFontOfSize:15*AppScale];
