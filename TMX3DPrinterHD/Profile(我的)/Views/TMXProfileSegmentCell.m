...
-(instancetype)initWithFrame:(CGRect)frame
{
    if (self == [super initWithFrame:frame]) {
        ...
        if ([FetchAppPublicKeyModel shareAppPublicKeyManager].isLogin) {
            ...
            self.bottomLineOne.userInteractionEnabled = YES;
            self.bottomLineTwo.userInteractionEnabled = YES;
            self.bottomLineThree.userInteractionEnabled = YES;
        }else
        {
            self.bottomLineOne.hidden = YES;
            self.bottomLineTwo.hidden = YES;
            self.bottomLineThree.hidden = YES;
            self.bottomLineOne.userInteractionEnabled = NO;
            self.bottomLineTwo.userInteractionEnabled = NO;
            self.bottomLineThree.userInteractionEnabled = NO;
        }
